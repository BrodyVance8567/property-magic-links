...
> Design notes for **property-magic-links** — a runnable typescript example that Typed Node service for property tenant magic-link sign-in.
...
- **Feature code** — the actual task: tenant access.
